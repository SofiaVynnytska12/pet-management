package com.mdotm.pets.repository.specification;
...
public class PetSpecification {
    ...
    public static Specification<Pet> withFilters(String name, String species, Integer age, String ownerName) {
        return (root, query, criteriaBuilder) -> {
            ...
            if (species != null) {
                predicate = criteriaBuilder.and(predicate, criteriaBuilder.equal(criteriaBuilder.lower(root.get("species")), "%" + species.toLowerCase() + "%"));
            }
            if (age != null) {
